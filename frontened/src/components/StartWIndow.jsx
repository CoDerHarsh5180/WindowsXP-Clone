  ...
  return (
    ...
    <div className=''>
        ...
        <div className='w-full h-screen bg-black flex flex-col justify-center items-center gap-10'>
            ...
            <div className='w-60 bg-black h-8 rounded-xl border-2 border-white flex items-center gap-2'>
                <span className='relative w-5 h-5 bg-linear-to-b from-blue-600 via-blue-950 to-blue-500  animate-[right_2.5s_linear_infinite] rounded-md '></span>
                <span className='relative w-5 h-5 bg-linear-to-b from-blue-600 via-blue-950 to-blue-500  animate-[right_2.5s_linear_infinite] rounded-md '></span>
                <span className='relative w-5 h-5 bg-linear-to-b from-blue-600 via-blue-950 to-blue-500  animate-[right_2.5s_linear_infinite] rounded-md '></span>
            </div>
